...
namespace ToolKit
{
    public static class CsvWriter
    {
        ...
        public static async Task WriteAsCsvToAsync<T>(this IEnumerable<T> source, string filename, bool includeHeader = true)
        {
            Contract.Requires(source != null);
            Contract.Requires(!string.IsNullOrEmpty(filename));

            using (var stream = new FileStream(filename, FileMode.Create, FileAccess.Write))
                await source.WriteAsCsvToAsync(stream, includeHeader);
        }
        ...
        public static void WriteAsCsvTo<T>(this IEnumerable<T> source, string filename, bool includeHeader = true)
        {
            Contract.Requires(source != null);
            Contract.Requires(!string.IsNullOrEmpty(filename));

            using (var stream = new FileStream(filename, FileMode.Create, FileAccess.Write))
                source.WriteAsCsvTo(stream, includeHeader);
        }
